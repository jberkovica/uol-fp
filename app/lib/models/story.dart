...
class Story {
  ...
  final String? audioError; // Error message if audio generation failed
  final String? backgroundMusicUrl;
  final String? caption; // Image caption generated by AI
  final String? coverImageUrl; // Generated cover image for story
  final String? coverImageThumbnailUrl; // Thumbnail version of cover image
  ...
  factory Story.fromJson(Map<String, dynamic> json) {
    return Story(
      ...
      audioError: _safeString(json['audio_error']),
      ...
      coverImageThumbnailUrl: _safeString(json['cover_image_thumbnail_url']),
  ...
  Story copyWith({
    ...
    return Story(
      ...
      coverImageThumbnailUrl: coverImageThumbnailUrl ?? this.coverImageThumbnailUrl,
...
enum StoryStatus {
  processing,  // Story is being generated (AI processing)
  pending,     // Story is waiting for parent approval
  approved,    // Story is approved and ready to read
  rejected,    // Story was rejected by parent
}
